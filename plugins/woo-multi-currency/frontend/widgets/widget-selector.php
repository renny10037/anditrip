...
if ( ! class_exists( 'WMC_Widget' ) ) {
	...
	class WMC_Widget extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( 'wmc_widget', // Base ID
				esc_attr__( 'Currency Selector', 'woo-multi-currency' ), // Name
				array( 'description' => esc_attr__( 'Change display currency on shop page. Widget of WooCommerce Multi Currency by VillaTheme', 'woo-multi-currency' ), ) // Args
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				...
				<input placeholder="<?php echo esc_attr__( 'Please enter your title', 'woo-multi-currency' ) ?>" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>"
