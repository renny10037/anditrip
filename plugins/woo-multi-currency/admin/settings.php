							...
							<td colspan="2">
								...
								<table class="vi-ui  table wmc-currency-options">
									...
									<tr>
										...
										<th class="two wide"><?php esc_html_e( 'Rate', 'woo-multi-currency' ) ?></th>
								...
								<p>
									<b>
										...
										<a class="vi-ui button" href="https://goo.gl/yaOf6s"><?php echo esc_html__( 'Update This Feature', 'woo-multi-currency' ) ?></a>
									</b>
								</p>
